...
public class FinalizarCompra extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for(int i=0; i<productos.size();i++){
            productos.get(i).calcularPrecioFinal();
            precioTotalCompra+=productos.get(i).getPrecioFinal();
        }
        
        request.setAttribute("productosComprados", productos);
        request.setAttribute("precioTotal",precioTotalCompra);
