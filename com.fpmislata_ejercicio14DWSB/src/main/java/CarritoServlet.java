...
public class CarritoServlet extends HttpServlet {
    ...
    public void init() throws ServletException{
        ...
        Producto prod1 = new Producto(1,"Leche",2,0);
        Producto prod2 = new Producto(2,"Cerveza",3,0);
        Producto prod3 = new Producto(3,"Pasteles",6,0);
        Producto prod4 = new Producto(4,"Helados",4,0);
        Producto prod5 = new Producto(5,"Cereales",5,0);
        Producto prod6 = new Producto(6,"Ensalada",2,0);
        productos.add(prod1);  
        productos.add(prod2);
        productos.add(prod3);
        productos.add(prod4);
